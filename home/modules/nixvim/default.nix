  ...
  programs.nixvim = {
    ...
    extraConfigLua = ''
      ...
      local rust_colors = {
        -- Reds/Warm
        muted_red = "#ef6068",
        muted_orange = "#e07830",      -- pushed more orange, less pink
        soft_orange = "#ffba50",
        muted_yellow = "#d4b020",      -- deeper, more golden

        -- Greens - spread across the spectrum
        muted_green = "#70a030",       -- slightly darker olive
        soft_green = "#b8e040",        -- kept lime-ish
        bright_green = "#40e870",      -- shifted cyan-green instead of yellow-green

        -- Aqua/Cyan - more separation
        muted_aqua = "#30b8a0",        -- deeper teal
        soft_aqua = "#60e8d0",         -- kept
        bright_aqua = "#80fff4",       -- pushed more cyan/white

        -- Blues - more range
        muted_blue = "#3080d0",        -- deeper
        soft_blue = "#50b0ff",         -- slightly adjusted
        bright_blue = "#90d8ff",       -- lighter, more sky

        -- Purples - wider spread
        muted_purple = "#9060e0",      -- deeper violet
        soft_purple = "#c090ff",       -- mid lavender
        bright_purple = "#e8b0ff",     -- pushed more pink/magenta
        ...
        white = "#ffffff",             -- Added white
                  ...
                  vim.api.nvim_create_autocmd("FileType", {
                    ...
                    callback = function()
                      -- Keywords (Purple)
                      vim.api.nvim_set_hl(0, "@keyword.rust", { fg = rust_colors.soft_purple })
                      vim.api.nvim_set_hl(0, "@keyword.function.rust", { fg = rust_colors.soft_purple })
                      vim.api.nvim_set_hl(0, "@keyword.operator.rust", { fg = rust_colors.soft_purple })
                      vim.api.nvim_set_hl(0, "@keyword.modifier.rust", { fg = rust_colors.soft_purple })
                      vim.api.nvim_set_hl(0, "@keyword.import.rust", { fg = rust_colors.soft_purple })
                      vim.api.nvim_set_hl(0, "@keyword.unsafe.rust", { fg = rust_colors.soft_purple, bold = true })
                      vim.api.nvim_set_hl(0, "@keyword.where.rust", { fg = rust_colors.soft_purple })
            
                      -- Control Flow (Bright Purple)
                      vim.api.nvim_set_hl(0, "@keyword.conditional.rust", { fg = rust_colors.bright_purple })
                      vim.api.nvim_set_hl(0, "@keyword.repeat.rust", { fg = rust_colors.bright_purple })
                      vim.api.nvim_set_hl(0, "@keyword.exception.rust", { fg = rust_colors.bright_purple })
                      vim.api.nvim_set_hl(0, "@keyword.return.rust", { fg = rust_colors.bright_purple })
                      ...
                      vim.api.nvim_set_hl(0, "@type.qualifier.rust", { fg = rust_colors.soft_purple })
            
                      -- Traits (Bright Green)
                      vim.api.nvim_set_hl(0, "@type.trait.rust", { fg = rust_colors.bright_green, italic = true })
            
                      -- Variables (Blue)
                      vim.api.nvim_set_hl(0, "@variable.rust", { fg = rust_colors.soft_blue })
                      vim.api.nvim_set_hl(0, "@variable.builtin.rust", { fg = rust_colors.bright_blue })
                      vim.api.nvim_set_hl(0, "@variable.member.rust", { fg = rust_colors.bright_blue })
            
                      -- Parameters (Muted Blue)
                      vim.api.nvim_set_hl(0, "@variable.parameter.rust", { fg = rust_colors.muted_blue })
            
                      -- Constants (Orange)
                      vim.api.nvim_set_hl(0, "@constant.rust", { fg = rust_colors.soft_orange })
                      vim.api.nvim_set_hl(0, "@constant.builtin.rust", { fg = rust_colors.soft_orange })
                      ...
                      vim.api.nvim_set_hl(0, "@string.regexp.rust", { fg = rust_colors.muted_orange })
            
                      -- Escapes and Special Chars (Muted Aqua)
                      vim.api.nvim_set_hl(0, "@string.escape.rust", { fg = rust_colors.muted_aqua })
                      vim.api.nvim_set_hl(0, "@string.special.rust", { fg = rust_colors.muted_aqua })
                      vim.api.nvim_set_hl(0, "@character.special.rust", { fg = rust_colors.muted_aqua })
                      ...
                      -- Namespaces/Modules (White)
                      vim.api.nvim_set_hl(0, "@module.rust", { fg = rust_colors.white })
                      vim.api.nvim_set_hl(0, "@namespace.rust", { fg = rust_colors.white })
            
                      -- Labels (Muted Red)
                      vim.api.nvim_set_hl(0, "@label.rust", { fg = rust_colors.muted_red })
            
                      -- Special punctuation (Muted Purple)
                      vim.api.nvim_set_hl(0, "@punctuation.special.rust", { fg = rust_colors.muted_purple })
                      vim.api.nvim_set_hl(0, "@punctuation.special.reference.rust", { fg = rust_colors.muted_purple })
            
                      -- Numbers (Orange)
                      vim.api.nvim_set_hl(0, "@number.rust", { fg = rust_colors.soft_orange })
                      vim.api.nvim_set_hl(0, "@number.float.rust", { fg = rust_colors.soft_orange })
            
                      -- Booleans (Orange)
                      vim.api.nvim_set_hl(0, "@boolean.rust", { fg = rust_colors.soft_orange })
            
                      -- Characters (Orange)
                      vim.api.nvim_set_hl(0, "@character.rust", { fg = rust_colors.soft_orange })
            
                      -- Lifetimes (Muted Purple)
                      vim.api.nvim_set_hl(0, "@lifetime.rust", { fg = rust_colors.muted_purple })
                      vim.api.nvim_set_hl(0, "@storageclass.lifetime.rust", { fg = rust_colors.muted_purple })
            
                      -- Enums (Yellow)
                      vim.api.nvim_set_hl(0, "@type.enum.rust", { fg = rust_colors.muted_yellow })
                      vim.api.nvim_set_hl(0, "@constant.enum.rust", { fg = rust_colors.soft_orange })
                      ...
                      -- Include (Purple)
                      vim.api.nvim_set_hl(0, "@include.rust", { fg = rust_colors.soft_purple })
            
                      -- Generic parameters (FG3)
                      vim.api.nvim_set_hl(0, "@type.parameter.rust", { fg = rust_colors.fg3 })
            
                      -- Attributes (Muted Green)
                      vim.api.nvim_set_hl(0, "@attribute.rust", { fg = rust_colors.muted_green })

                      -- LSP Semantic Token Highlights
                      vim.api.nvim_set_hl(0, "@lsp.type.namespace.rust", { fg = rust_colors.white })
                      ...
                      vim.api.nvim_set_hl(0, "@lsp.type.interface.rust", { fg = rust_colors.bright_green, italic = true })
                      vim.api.nvim_set_hl(0, "@lsp.type.struct.rust", { fg = rust_colors.muted_yellow })
                      vim.api.nvim_set_hl(0, "@lsp.type.typeParameter.rust", { fg = rust_colors.fg3 })
                      vim.api.nvim_set_hl(0, "@lsp.type.parameter.rust", { fg = rust_colors.muted_blue })
                      ...
                      vim.api.nvim_set_hl(0, "@lsp.type.enumMember.rust", { fg = rust_colors.soft_orange })
                      ...
                      vim.api.nvim_set_hl(0, "@lsp.type.keyword.rust", { fg = rust_colors.soft_purple })
                      ...
                      vim.api.nvim_set_hl(0, "@lsp.type.number.rust", { fg = rust_colors.soft_orange })
                      vim.api.nvim_set_hl(0, "@lsp.type.operator.rust", { fg = rust_colors.fg3 })
                      vim.api.nvim_set_hl(0, "@lsp.type.lifetime.rust", { fg = rust_colors.muted_purple })
                      vim.api.nvim_set_hl(0, "@lsp.type.builtinType.rust", { fg = rust_colors.muted_yellow })
                      vim.api.nvim_set_hl(0, "@lsp.type.selfKeyword.rust", { fg = rust_colors.soft_purple })
                      vim.api.nvim_set_hl(0, "@lsp.type.selfTypeKeyword.rust", { fg = rust_colors.muted_yellow })
                      vim.api.nvim_set_hl(0, "@lsp.type.deriveHelper.rust", { fg = rust_colors.muted_green })
                      vim.api.nvim_set_hl(0, "@lsp.type.formatSpecifier.rust", { fg = rust_colors.muted_aqua })
